...
INSERT INTO `json_codes` (`id`, `code`, `status`, `message`) VALUES
	(-1, 'unknown_error', 500, 'There was an unknown error'),
	(0, 'missing_fields', 400, 'Please enter all fields'),
	(1, 'wrong_login', 403, 'Wrong Username or Password'),
	(2, 'password_to_long', 400, 'Password must be shorter than 256 chars'),
	(3, 'unmatching_passwords', 400, 'Passwords do not match'),
	(4, 'registration_success', 200, 'Registration successfull'),
	(5, 'login_successfull_redirect', 202, 'Login successfull Redirecting...'),
	(6, 'not_signed_in', 401, 'You are not signed in'),
	(7, 'wrong_data_type', 400, '%param% must be %type%'),
	(8, 'var_must_be_above', 400, '%var% must be above %min%'),
	(9, 'illegal_characters_password', 400, 'Your password contains illegal characters'),
	(10, 'already_logged_out', 400, 'You are already logged out'),
	(11, 'logged_out', 200, 'Logged out successfully'),
	(12, 'nothing_changed', 202, 'Es hat sich nichts geändert'),
	(13, 'bad_number_exception', 418, 'Ain\'t cookling tea with that number'),
	(14, 'field_to_short', 400, '%field% needs to be at least %length% characters long'),
	(15, 'field_to_long', 400, '%field% can only be %length% characters long'),
	(16, 'account_settings_updated', 200, 'Your account information has been updated'),
	(17, 'updated_password', 200, 'Your password was updated successfully'),
	(18, 'new_and_old_passwords_match', 400, 'Your old and new passwords are the same'),
	(19, 'already_smash', 400, 'Du scheinst die Person ja sehr zu mögen. Du hast sie schon markiert'),
	(20, 'smash_limit_reached', 400, 'You can only mark 5 people as smash'),
	(21, 'added_smash', 200, 'Successfully marked as smash'),
