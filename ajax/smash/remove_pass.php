...
if ($result -> num_rows <= 0) {
    echo get_json_answer(true, "not_marked_as_pass", [], [], $con);
    return;
}

$result = prepared_statement_result("DELETE FROM pass WHERE uid = ? AND target = ?", $con, true, "ss", $uid, $user);
echo get_json_answer(false, "removed_pass", [], [], $con);
